...
public class OrganizationDictionary
{
    ...
    static
    {
        ...
        dictionary.load(MyNLP.Config.OrganizationDictionaryPath);
        logger.info(MyNLP.Config.OrganizationDictionaryPath + "加载成功，耗时" + (System.currentTimeMillis() - start) + "ms");
        transformMatrixDictionary = new TransformMatrixDictionary<NT>(NT.class);
        transformMatrixDictionary.load(MyNLP.Config.OrganizationDictionaryTrPath);
        // TODO:什么时候有空了升级到双数组吧
