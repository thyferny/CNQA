...
public class SYTDictionary
{
    ...
    static
    {
        ...
        if (dictionary.load(MyNLP.Config.SYTDictionaryPath))
        {
            logger.info("载入声母韵母音调词典" + MyNLP.Config.SYTDictionaryPath + "成功");
        ...
        {
            logger.warning("载入声母韵母音调词典" + MyNLP.Config.SYTDictionaryPath + "失败");
        }
    }
