...
public class PinyinDictionary
{
    ...
    static
    {
        ...
        if (!load(MyNLP.Config.PinyinDictionaryPath))
        {
            throw new IllegalArgumentException("拼音词典" + MyNLP.Config.PinyinDictionaryPath + "加载失败");
        }

        logger.info("拼音词典" + MyNLP.Config.PinyinDictionaryPath + "加载成功，耗时" + (System.currentTimeMillis() - start) + "ms");
    }
